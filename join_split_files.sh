...
cat system/system/app/BixbyOnDevice/BixbyOnDevice.apk.* 2>/dev/null >> system/system/app/BixbyOnDevice/BixbyOnDevice.apk
rm -f system/system/app/BixbyOnDevice/BixbyOnDevice.apk.* 2>/dev/null
...
cat system/system/priv-app/SumeNNService/SumeNNService.apk.* 2>/dev/null >> system/system/priv-app/SumeNNService/SumeNNService.apk
rm -f system/system/priv-app/SumeNNService/SumeNNService.apk.* 2>/dev/null
